...
![React size](https://img.shields.io/github/followers/Hollbrok?style=social)
...
```c++
    #define HIGH_SEC   // High security
    // or
    #define MEDIUM_SEC // Medium security
    // or
    #define LOW_SEC    // Low security
``` 
